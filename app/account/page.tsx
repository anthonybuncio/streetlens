  ...
  return (
    <>
      <section className="h-screen">
        <form className="container max-w-2xl mx-auto shadow-md md:w-3/4 mt-20">
          ...
          <div className="space-y-6 bg-zinc-900">
            <div className="items-center w-full p-4 space-y-4 text-white md:inline-flex md:space-y-0">
              ...
              <div className="max-w-sm mx-auto md:w-2/3">
                <div className=" relative ">
                  <input
                    type="text"
                    id="user-info-email"
                    className=" rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-zinc-800 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
            ...
            <hr />
            <div className="items-center w-full p-8 space-y-4 text-white md:inline-flex md:space-y-0">
            ...
            <hr />
            <div className="w-full px-4 pb-4 ml-auto text-white md:w-1/3">
              <button
                type="submit"
