...
const Footer = () => {
  return (
    // <footer className="fixed bottom-0 left-0 z-20 w-full py-2 bg-zinc-900 text-neutral-400 border-t border-zinc-700 shadow md:flex md:items-center md:justify-between md:p-2">
    //   <div className=" w-full px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
    ...
    <footer className="fixed bottom-0 left-0 z-20 w-full px-4 py-2 bg-zinc-900 text-neutral-400 border-t border-zinc-700 shadow ">
